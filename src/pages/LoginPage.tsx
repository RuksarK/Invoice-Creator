    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium">Sign in to your InvoiceFly account</p>
        </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" title="Forgot Password" className="text-xs text-primary hover:underline font-medium uppercase tracking-wider">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
